...
if __name__ == '__main__':
    ...
    # Test the model
    accuracy_predict = srbm.predict(teX, teY)
    print('Test set accuracy: {}'.format(accuracy_predict))

    
    import json
    accuracy_final = np.float64(accuracy_predict)
    result = { 'accuracy' : accuracy_final }
    file = open(file="buggy/result.json",mode="w",encoding="utf-8")
